(async () => {
  ...
  const initializeInternal = (await (globalThis.importProxy?.bind(null, "content/Blazor.BrowserExtension") ?? (m => import(m)))(`${url}content/Blazor.BrowserExtension/CoreInternal.js`)).initializeInternal;
